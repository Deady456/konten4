...
from . import script, voice, captions, visuals, mystery_visuals, assemble, assemble_vanta, upload, state, visuals_ai
...
def run_once(publish_at: str | None = None, upload_to_youtube: bool = True,
    ...
    # ============================================================
    # Step 4: Fetch Asian mystery & horror visuals (FLUX + Wikimedia)
    _log("4/8 Fetching Asian mystery & horror visuals")
    scene_videos = mystery_visuals.fetch_all(data["scenes"], work / "broll", words=words, voice_audio=voice_mp3)
